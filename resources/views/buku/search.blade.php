<x-app-layout>
    ...
    <head>
        ...
        <!-- Add other style links if necessary -->
        <style>
    ...
    <body>
        <div class="container mt-4">
            ...
            <!-- Pesan ketika data buku yang dicari tidak ada -->
            @if($data_buku->isEmpty())
            <div class="alert alert-danger text-center" role="alert" style="clear: both;">
                Tidak ada data buku dengan nama <strong>"{{ request('kata') }}"</strong>
            </div>
            @else
            ...
            <div class="text-center">
                <!-- Menampilkan pesan pagination -->
                {{ $data_buku->links('vendor.pagination.bootstrap-5') }}
            </div>
            @endif
        </div>
</x-app-layout>
